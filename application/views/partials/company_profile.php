                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal adminex-form" id="commentForm" method="get" action="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-4">
                                            <input datepicker class="form-control " id="cemail" type="text" name="email" required />
                                           </div>
                                        <label for="curl" class="control-label col-lg-2">Book Begining From (required)</label>
                                        <div class="col-lg-4">
                                            <input datepicker class="form-control " id="cemail" type="text" name="email" required /> </div>
                                    </div>
                                    <div class="form-group">
