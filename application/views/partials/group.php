       ...
       <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="create_group" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" ng-init="resetSelectedGroup();">
                     <div class=" form">
                     <form class="cmxform form-horizontal adminex-form"  ng-submit="createGroup();" method="get" action="">
                        <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-2">Name (required)</label>
                                        <div class="col-lg-4">
                                            <input class=" form-control" minlength="2" type="text" ng-model="selectedGroup.name" required />
                                        </div>
